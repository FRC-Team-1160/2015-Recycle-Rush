 ...
 *
 */
public class DriveDiagFL extends Command {

	private double distance;
	
    public DriveDiagFL(double distance) {
    	requires(Robot.dt);
    ...
    protected void initialize() {
    	Robot.dt.reset();
    	Robot.dt.enable();
    	System.out.println("moving diagonally forward left : " + distance + " meters");
    }

    // Called repeatedly when this Command is scheduled to run
    protected void execute() {
    	Robot.dt.diagFL(distance);
